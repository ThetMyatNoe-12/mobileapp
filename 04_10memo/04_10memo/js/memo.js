...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (typeof localStorage === "undefined") {
        ...
        // C: イベント委任 - table1にイベントリスナーを設定
        // ここでクリックしたイベントをキャッチできる
        const table1 = document.getElementById("table1");
        table1.addEventListener("click", function (e) {
            // クリックした要素がtrashクラスを持っているか確認
            if (e.target.classList.contains("trash")) {
                e.preventDefault();
                // e.target.parentNode は td
                // e.target.parentNode.parentNode は tr
                ...
                Swal.fire({
                    title: "Memo app",
                    html: "localStorageから<br>" + key + ": " + value + "<br>を削除(delete)してもよろしいですか？",
                    type: "warning",
                    ...
                    if (result.value === true) {
                        ...
                        Swal.fire({
                            title: "Memo app",
                            html: "localStorageから<br>" + key + ": " + value + "<br>を削除(delete)しました。",
                            type: "success",
                            allowOutsideClick: false
                        });
                    }
...
function viewStorage() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
        ...
        let td4 = document.createElement("td"); // ゴミ箱用のセル
        ...
        // ゴミ箱アイコンを追加
        td4.innerHTML = '<span class="trash">🗑️</span>';
    }
